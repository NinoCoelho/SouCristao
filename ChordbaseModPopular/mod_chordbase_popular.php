...
. "\n ORDER BY a.views DESC LIMIT $count"
;
...
foreach ( $rows as $row ) {
	...
	echo '<tr><td align="left" width="100%"><li><a href="'. sefRelToAbs( 'index.php?option=com_chordbase&amp;task=viewSong&amp;song_id='. $row->song_id ) .'">'. $row->title .'</a></li></td><td align="right">'.$row->views.'</td></tr>';
